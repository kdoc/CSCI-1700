...
public class Date 
{
	private int month;//changed to integer
	private int day;
	private int year;//a four digit number
	
	public Date()
	{
		month = 1;//changed to integer
		day = 1;
		year = 1000;
	}
	...
	public void setDate(String monthString, int day, int year)//changed
	{
		if(dateOK(monthString, day, year))
		{
			//if else added to convert string to integer
	...
	public boolean equals(Date otherDate)//changed
	{
		return ( (month == otherDate.month)
				&& (day == otherDate.day) && (year == 
				otherDate.year) );
	}
	public boolean precedes(Date otherDate)//changed
	{
	...
	public void readInput()//changed to accept example input
	{
		...
		while (tryAgain)
		{
			...
			int monthInput = keyboard.nextInt();//changed
			...
			keyboard.close();//added to remove warning
		}
	}
	...
	private boolean dateOK(String monthString, int dayInt, int 
							   yearInt)
	{
