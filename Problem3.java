...
{	
	...
	public void wordStatistics(File fileIn, File fileOut)
	{
		...
		fileOutput.printf("Total number of words = %d\r\n" + 
				"Average word length = %f characters.\r\n" + 
				"Total number of word characters = %d\r\n" + 
				"Total number of punctuation characters = %d\r\n" + 
				"Shortest word length = %d\r\n" + 
	...
	public void shortestWords(File fileIn, File fileOut)
	{
	...
	public void longestWords(File fileIn, File fileOut)
	{
	...
	public void search(File fileIn, File fileOut, String keyword)
	{
		Scanner fileInput = inputFileManager(fileIn);
		PrintWriter fileOutput = outputFileManager(fileOut);
		String s = null, list = "";
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Filename entered: " + fileIn);
		do
		{
			...
			try
			{
				...
				{
					case 1:
						p3.wordStatistics(fileIn,fileOut);
						break;
					case 2:
						p3.shortestWords(fileIn,fileOut);
						break;
					case 3:
						p3.longestWords(fileIn,fileOut);
						break;
					case 4:
						System.out.println("Enter word to find in file: ");
						String keyword = keyboard.next();
						p3.search(fileIn,fileOut, keyword);
						break;
					case 5:
